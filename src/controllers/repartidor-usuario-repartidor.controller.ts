...
export class RepartidorUsuarioRepartidorController {
  ...
  async get(
    ...
    return this.repartidorRepository.tiene_un(id).get(filter);
  }
  ...
  async create(
    ...
    return this.repartidorRepository.tiene_un(id).create(usuarioRepartidor);
  }
  ...
  async patch(
    ...
    return this.repartidorRepository.tiene_un(id).patch(usuarioRepartidor, where);
  }
  ...
  async delete(
    ...
    return this.repartidorRepository.tiene_un(id).delete(where);
  }
}
